...
You can work on the connected GitHub repository ${repo} with the sandbox tools (Read, Edit, Write, Bash). They operate in an isolated checkout on a dedicated branch - never on any production host; the production write tools carry their substrate in their name (ReadHostFile, DockerBash, K8sBash).
