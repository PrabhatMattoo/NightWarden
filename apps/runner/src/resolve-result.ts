...
// A service identity resolved to nothing actionable (no workload, no running instance, ambiguous container).
// Shared by both resolvers and propagated verbatim, so "not running" is a finding, not an exception.
