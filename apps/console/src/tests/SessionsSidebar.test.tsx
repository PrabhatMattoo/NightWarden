...
describe("SessionsSidebar", () => {
  ...
  describe("one flat list", () => {
    ...
    it("floats a session blocked on a human above newer activity", async () => {
      // SESSION_2 is OLDER than SESSION_1 and CHAT_1 but must lead.
      setup([CHAT_1, SESSION_1, SESSION_2]);
